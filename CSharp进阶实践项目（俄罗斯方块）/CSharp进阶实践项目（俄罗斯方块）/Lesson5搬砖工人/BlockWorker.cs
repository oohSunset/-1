...
namespace CSharp进阶实践项目_俄罗斯方块_
{
    ...
    class BlockWorker : IDraw
    {
        ...
        //搬砖工人要知道，各个形状的方块信息是什么
        //选择一个容器来记录各个方块的形态信息
        //用list和Dictionary都可以用来存储方块的几种信息
        //选择Dictionary的主要目的是好找 并且起到练习的作用
        ...
        public void AutoMove()
        {
            ...
            //首先要得到移动的多少
            //Position downMove = new Position();  //向量移动的方法，Unity中比较常用
            //得到所有的方块 让其向下移动
            for (int i = 0; i < blocks.Count; i++)
            {
